...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Area.codezone'
        db.delete_column(u'backend_area', 'codezone')

        # Removing M2M table for field species on 'Area'
        db.delete_table(db.shorten_name(u'backend_area_species'))

        # Removing index on 'Individual', fields ['name']
        db.delete_index(u'backend_individual', ['name'])
        ...
        # Removing index on 'Species', fields ['name_fr']
        db.delete_index(u'backend_species', ['name_fr'])

        # Removing index on 'Species', fields ['name_it']
        db.delete_index(u'backend_species', ['name_it'])

        # Removing index on 'Species', fields ['name_en']
        db.delete_index(u'backend_species', ['name_en'])

        # Removing index on 'Species', fields ['name']
        db.delete_index(u'backend_species', ['name'])
    ...
    models = {
        ...
        u'backend.area': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lat': ('django.db.models.fields.FloatField', [], {'default': '44.738718'}),
            'lon': ('django.db.models.fields.FloatField', [], {'default': '3.725422'}),
