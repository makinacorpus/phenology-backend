...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Observer.category'
        db.add_column(u'backend_observer', 'category',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=80, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Observer.category'
        db.delete_column(u'backend_observer', 'category')
    ...
    models = {
        ...
        u'backend.observer': {
            ...
            'category': ('django.db.models.fields.CharField', [], {'max_length': '80', 'blank': 'True'}),
