...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Stage.date_end'
        db.delete_column(u'backend_stage', 'date_end')

        # Deleting field 'Stage.date_start'
        db.delete_column(u'backend_stage', 'date_start')


    def backwards(self, orm):
        # Adding field 'Stage.date_end'
        db.add_column(u'backend_stage', 'date_end',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Stage.date_start'
        db.add_column(u'backend_stage', 'date_start',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)
