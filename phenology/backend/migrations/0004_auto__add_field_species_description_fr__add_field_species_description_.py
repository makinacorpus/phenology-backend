...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Species.description_fr'
        db.add_column(u'backend_species', 'description_fr',
                      self.gf('django.db.models.fields.TextField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Species.description_it'
        db.add_column(u'backend_species', 'description_it',
                      self.gf('django.db.models.fields.TextField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Species.description_en'
        db.add_column(u'backend_species', 'description_en',
                      self.gf('django.db.models.fields.TextField')(max_length=500, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Species.description_fr'
        db.delete_column(u'backend_species', 'description_fr')

        # Deleting field 'Species.description_it'
        db.delete_column(u'backend_species', 'description_it')

        # Deleting field 'Species.description_en'
        db.delete_column(u'backend_species', 'description_en')
