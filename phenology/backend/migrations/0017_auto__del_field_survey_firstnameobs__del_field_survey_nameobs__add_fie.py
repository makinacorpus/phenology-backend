...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Survey.firstnameobs'
        db.delete_column(u'backend_survey', 'firstnameobs')

        # Deleting field 'Survey.nameobs'
        db.delete_column(u'backend_survey', 'nameobs')

        # Adding field 'Survey.name_obs'
        db.add_column(u'backend_survey', 'name_obs',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Survey.firstname_obs'
        db.add_column(u'backend_survey', 'firstname_obs',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Survey.firstnameobs'
        db.add_column(u'backend_survey', 'firstnameobs',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Survey.nameobs'
        db.add_column(u'backend_survey', 'nameobs',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Deleting field 'Survey.name_obs'
        db.delete_column(u'backend_survey', 'name_obs')

        # Deleting field 'Survey.firstname_obs'
        db.delete_column(u'backend_survey', 'firstname_obs')
