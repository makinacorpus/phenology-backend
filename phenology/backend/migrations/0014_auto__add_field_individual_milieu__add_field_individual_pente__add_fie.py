...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Individual.milieu'
        db.add_column(u'backend_individual', 'milieu',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Individual.pente'
        db.add_column(u'backend_individual', 'pente',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Individual.exposition'
        db.add_column(u'backend_individual', 'exposition',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Individual.milieu'
        db.delete_column(u'backend_individual', 'milieu')

        # Deleting field 'Individual.pente'
        db.delete_column(u'backend_individual', 'pente')

        # Deleting field 'Individual.exposition'
        db.delete_column(u'backend_individual', 'exposition')
