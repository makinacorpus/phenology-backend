...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'backend_area', 'region',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'Area.departement'
        db.add_column(u'backend_area', 'departement',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)
        ...
        # Changing field 'Snowing.area'
        db.alter_column(u'backend_snowing', 'area_id', self.gf('select2.fields.ForeignKey')(to=orm['backend.Area'], search_field='name'))

    def backwards(self, orm):
        # Deleting field 'Area.region'
        db.delete_column(u'backend_area', 'region')

        # Deleting field 'Area.departement'
        db.delete_column(u'backend_area', 'departement')


        # Changing field 'Snowing.observer'
        db.alter_column(u'backend_snowing', 'observer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['backend.Observer']))

        # Changing field 'Snowing.area'
        db.alter_column(u'backend_snowing', 'area_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['backend.Area']))
    ...
    models = {
        ...
        u'backend.area': {
            ...
            'departement': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'backend.snowing': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'observer': ('select2.fields.ForeignKey', [], {'to': u"orm['backend.Observer']", 'search_field': "'user'"}),
