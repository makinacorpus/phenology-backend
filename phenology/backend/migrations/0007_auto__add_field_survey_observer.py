...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Survey.observer'
        db.add_column(u'backend_survey', 'observer',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['backend.Observer'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Survey.observer'
        db.delete_column(u'backend_survey', 'observer_id')
