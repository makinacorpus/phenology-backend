...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique(u'backend_area', ['name'])


        # Changing field 'Snowing.height'
        db.alter_column(u'backend_snowing', 'height', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):
        # Removing unique constraint on 'Area', fields ['name']
        db.delete_unique(u'backend_area', ['name'])


        # Changing field 'Snowing.height'
        db.alter_column(u'backend_snowing', 'height', self.gf('django.db.models.fields.FloatField')())
