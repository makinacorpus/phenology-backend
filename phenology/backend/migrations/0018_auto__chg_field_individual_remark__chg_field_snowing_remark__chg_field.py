...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Individual.remark'
        db.alter_column(u'backend_individual', 'remark', self.gf('django.db.models.fields.TextField')(max_length=100))

        # Changing field 'Snowing.remark'
        db.alter_column(u'backend_snowing', 'remark', self.gf('django.db.models.fields.TextField')(max_length=100))

        # Changing field 'Survey.remark'
        db.alter_column(u'backend_survey', 'remark', self.gf('django.db.models.fields.TextField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Individual.remark'
        db.alter_column(u'backend_individual', 'remark', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Snowing.remark'
        db.alter_column(u'backend_snowing', 'remark', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Survey.remark'
        db.alter_column(u'backend_survey', 'remark', self.gf('django.db.models.fields.CharField')(max_length=100))
