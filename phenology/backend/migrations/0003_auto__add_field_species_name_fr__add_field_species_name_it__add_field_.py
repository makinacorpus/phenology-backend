...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Species.name_fr'
        db.add_column(u'backend_species', 'name_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Species.name_it'
        db.add_column(u'backend_species', 'name_it',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Species.name_en'
        db.add_column(u'backend_species', 'name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Species.name_fr'
        db.delete_column(u'backend_species', 'name_fr')

        # Deleting field 'Species.name_it'
        db.delete_column(u'backend_species', 'name_it')

        # Deleting field 'Species.name_en'
        db.delete_column(u'backend_species', 'name_en')
