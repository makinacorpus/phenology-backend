...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Stage.name_ca'
        db.add_column(u'backend_stage', 'name_ca',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Species.name_ca'
        db.add_column(u'backend_species', 'name_ca',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Species.description_ca'
        db.add_column(u'backend_species', 'description_ca',
                      self.gf('django.db.models.fields.TextField')(max_length=500, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Stage.name_ca'
        db.delete_column(u'backend_stage', 'name_ca')

        # Deleting field 'Species.name_ca'
        db.delete_column(u'backend_species', 'name_ca')

        # Deleting field 'Species.description_ca'
        db.delete_column(u'backend_species', 'description_ca')
    ...
    models = {
        ...
        u'backend.area': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lat': ('django.db.models.fields.FloatField', [], {'default': '45.930659'}),
            'lon': ('django.db.models.fields.FloatField', [], {'default': '6.86375'}),
